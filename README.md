...
## The java.nogue team social support group.
## ![23](https://github.com/NikolayTach/JAVA.NOGUE/blob/main/.github/KOR_3211.jpg) 
## ![24](https://github.com/NikolayTach/JAVA.NOGUE/blob/main/.github/KOR_3483.jpg)
Low-level discovery can also be customized. As a specification of low-level discovery, any value can be handled as long as the following conference name format response can be obtained. 
...
## ![1](https://github.com/NikolayTach/JAVA.NOGUE/blob/main/.github/nogue%20emoji.png) ( JSR 391) Platform Specification Unit



|                              |    Classes	   |     Interfaces            |         Exceptions         |
|------------------------------|---------------------|-----------------|----------------------------|
|JDK16.io.Open.Service.Packs	| BufferedInputStream	|  Closeable	|     WriteAbortedException   |
|JDK16.io.Open.Jet.Packs	| FileWriter	|   DataInput           |     NotSerializableException      |
|JDK16.io.Open.Wig.Packs	| ObjectStreamClass |  ObjectInputValidation    |     NotSerializableException      |
